...
export default {
  ...
  image_stage_asset_label: "资产生成",
  image_stage_asset_caption: "角色、场景、道具和商品资产图的生成与编辑。",
  image_stage_reference_label: "参考图",
  image_stage_reference_caption: "项目参考图制作；留空时沿用默认图片模型。",
  image_stage_storyboard_label: "Storyboard",
  image_stage_storyboard_caption: "普通分镜、多宫格分镜和 Video Unit Storyboard Sheet。",
  image_stage_keyframe_label: "关键帧",
  image_stage_keyframe_caption: "Video Unit 关键首帧的生成与编辑。",
