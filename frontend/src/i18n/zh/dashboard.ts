...
export default {
  ...
  'config_import_title': '导入本地运行配置',
  'config_import_description': '拖入管理员提供的 .env.release 文件，即可一次性加载 Agent、渠道与 Supabase 配置。文件只在本机后端内存中解析，不会上传到云端。',
  'config_import_drop': '将配置文件拖到这里',
  'config_import_hint': '或点击选择 .env / .env.release 文件，最大 1 MB',
  'config_import_choose_file': '选择本地配置文件',
  'config_import_importing': '正在安全导入配置…',
  'config_import_later': '稍后配置',
  'config_import_file_type_error': '请选择 .env 或 .release 配置文件',
  'config_import_incomplete': '文件已导入，但仍有必需配置缺失',
  'config_import_missing': '当前缺少：{{items}}',
  'config_import_issue_agent': 'Agent',
  'config_import_issue_supabase': 'Supabase 角色目录',
  'config_import_issue_provider_image': '图片渠道',
  'config_import_issue_provider_video': '视频渠道',
  'config_import_issue_provider_text': '文本渠道',
  'environment_import_nav': '导入环境',
  'environment_import_kicker': 'Environment',
  'environment_import_title': '导入并更新环境配置',
  'environment_import_description': '拖入新的 .env.release 文件，统一替换 Agent、渠道和系统设置，并让所有项目重新继承新环境。',
  'environment_import_checking': '正在校验配置文件…',
  'environment_import_warning': '该操作会停用文件外的旧渠道凭证，并清除全部项目的模型、分辨率、文本和音频覆盖；项目内容、素材、风格与生成结果不会改变。',
  'environment_import_confirm_title': '确认替换当前运行环境？',
  'environment_import_confirm_description': '配置文件已通过校验。应用后当前环境会按下列范围更新：',
  'environment_import_preview_providers': '内置渠道 {{builtin}} 个，自定义渠道 {{custom}} 个',
  'environment_import_preview_settings': '系统设置 {{count}} 项',
  'environment_import_preview_projects': '重置运行配置的项目 {{count}} 个',
  'environment_import_confirm': '替换环境',
  'environment_import_success': '环境配置已更新，所有项目已改为继承新设置',
  ...
  'workflow_start_production': '开始制作',
  'workflow_next_step': '下一步',
  'workflow_start_production_prompt': '开始制作。请查询当前项目的最新工作流计划，并执行下一步：{{step}}。',
  'workflow_continue_prompt': '请查询当前项目的最新工作流计划，并执行下一步：{{step}}。',
  ...
  'task_type_reference_video_refine': '高清处理',
  'task_type_tts': '配音',
  'task_type_voice_sample': '试听样本',
  'task_type_grid': '多宫格分镜',
  'task_type_hyperframes_bgm': 'HyperFrames 背景音乐',
  ...
  'project_path_revealed': '已在文件管理器中定位「{{path}}」',
  'project_path_reveal_failed': '无法定位项目文件：{{message}}',
  'project_path_no_active_project': '当前没有可定位的项目',
  ...
  'episode_narrator_label': '本集旁白',
  'episode_narrator_inherit_value': '继承项目 · {{name}}',
  'episode_narrator_inherit_empty': '继承项目 · 由模型决定',
  'episode_narrator_saved': '本集旁白已更新',
  ...
  'default_narrator_title': '默认旁白',
  'default_narrator_label': '旁白角色',
  'default_narrator_none': '不指定 · 由模型决定',
  'default_narrator_hint': '脚本中的裸 {旁白} 会在 H3 中使用该角色的参考音频；每一集也可以单独覆盖。',
  ...
  'route_reference_video_desc': '按视频单元从正式文稿并行生成故事板与关键分镜，分别审核后与资产图一起作为视频参考',
  ...
  'reference_editor_view_storyboard': '故事板',
  'reference_storyboard_sheet_title': '故事板',
  'reference_storyboard_sheet_confirmed_badge': '已确认',
  'reference_storyboard_sheet_pending_badge': '待确认',
  'reference_storyboard_sheet_generating': '正在生成故事板…',
  'reference_storyboard_sheet_not_generated': '故事板尚未生成',
  'reference_storyboard_sheet_help': '这是当前整个视频单元的镜头顺序与场景变化预览。故事板与关键分镜都直接来自正式文稿，可并行生成并分别审核。',
  'reference_storyboard_sheet_generate': '生成故事板',
  'reference_storyboard_sheet_regenerate': '重新生成故事板',
  'reference_storyboard_sheet_description': '故事板图片描述',
  'reference_storyboard_sheet_prompt_mode': '切换故事板图片提示词模式',
  'reference_storyboard_sheet_full_prompt': '故事板完整 Prompt',
  'reference_storyboard_sheet_description_placeholder': '使用与正式文稿一致的 @[角色]、@[场景]、@[道具] 描述故事板内容',
  'reference_storyboard_sheet_instructions_label': '本次生成审核意见',
  'reference_storyboard_sheet_instructions_placeholder': '可选：填写本次生成或重生成必须落实的逐格修改意见；不会改写正式脚本。',
  'reference_storyboard_sheet_confirm_and_generate': '确认故事板',
  'reference_storyboard_sheet_confirm': '确认故事板',
  'reference_storyboard_sheet_manuscript_changed_hint': '正式文稿或图片描述在这张故事板生成后有过变动。当前结果仍可继续使用，也可由你决定是否重新生成。',
  'reference_keyframe_storyboard_gate': '故事板与关键分镜是同级产物，可直接从正式文稿独立生成。',
  ...
  'reference_keyframe_prompt_mode': '切换关键分镜图片提示词模式',
  'reference_keyframe_full_prompt': '关键分镜完整 Prompt',
  'reference_image_prompt_mode_description': '画面描述',
  'reference_image_prompt_mode_full': '完整 Prompt',
  'reference_image_full_prompt_placeholder': '这里显示并编辑本画面实际提交给生图模型的完整 Prompt',
  ...
  'script_preview_define_voice': '去定义音色',
  ...
  'course_episode_analysis_tab': '单集解析',
  'course_episode_analysis_draft': '待确认',
  'course_episode_analysis_confirmed': '已完成',
  'course_episode_save_and_confirm': '保存并标记完成',
  'course_episode_overview_confirmed': '本集解析已保存并标记完成',
  'course_episode_overview_confirm_failed': '保存本集解析失败：{{message}}',
  ...
  'hyperframes_editing_state_assembly_draft': '顺序拼接底稿 · 尚未应用 AI 画面剪辑',
  'hyperframes_editing_state_edited': 'AI 画面剪辑已应用（{{count}} 项证据）',
  'hyperframes_retry': '重试',
  'hyperframes_open_new_window': '在新窗口打开',
  'hyperframes_bgm_task_progress': '背景音乐生成进度',
  'hyperframes_bgm_status_queued': '背景音乐等待生成（队列位置 {{position}}）',
  'hyperframes_bgm_status_running': '正在生成背景音乐 {{progress}}%',
  'hyperframes_bgm_status_cancelling': '正在取消背景音乐任务…',
  'hyperframes_bgm_status_succeeded': '背景音乐已生成并加入时间线',
  'hyperframes_bgm_status_failed': '背景音乐生成失败',
  'hyperframes_bgm_status_cancelled': '背景音乐任务已取消',
  ...
  'tool_name_get_project_path_link': '生成项目文件定位链接',
  ...
  'tool_name_generate_reference_storyboard_sheets': '生成视频单元故事板',
  'tool_name_generate_reference_keyframes': '生成参考视频关键帧',
  'tool_name_normalize_reference_keyframe_mentions': '规范关键帧资产引用',
  'tool_name_replace_reference_script_text': '批量精确修正文稿',
  ...
  'tool_name_confirm_reference_video': '确认当前视频',
  ...
  'tool_name_inspect_hyperframes_episode': '检查 HyperFrames 剪辑状态',
  'tool_name_generate_hyperframes_bgm': '生成 HyperFrames 背景音乐',
  'tool_name_make_reference_video_hd': '高清处理',
  'tool_name_cancel_reference_video_tasks': '取消视频任务',
  ...
  'tool_name_patch_episode_meta': '编辑分集信息',
  'tool_name_confirm_episode_overview': '确认单集解析',
  ...
  'lobby_hero_subtitle_cheerup': '让好故事动起来。',
  ...
  'course_unit_type': '单元类型',
  'course_unit_opening': '引子',
  'course_unit_story': '故事演绎',
  'course_unit_explanation': '知识解说',
  'course_unit_closing': '结尾总结',
  'course_unit_related_assets': '文稿相关素材',
  'course_unit_assets_empty': '未引用',
  'course_unit_scenes': '场景',
  'course_unit_characters': '角色',
  'course_unit_presenters': '讲师',
  'course_unit_props': '道具',
  'course_role': '课程角色',
  'course_role_actor': '演员',
  'course_role_main_lecturer': '主讲讲师',
  'course_role_guest_lecturer': '特邀讲师',
  'course_video_confirm': '确认当前视频',
  'course_video_confirmed': '视频已确认',
  'reference_video_hd': '高清',
  'reference_video_hd_processing': '高清处理中',
  'reference_video_hd_completed': '已高清',
  'reference_video_hd_retry': '重试',
  'reference_video_hd_preview_label': '高清视频',
  'reference_video_hd_preview_empty': '确认开始高清处理后，将在这里显示进度和成片',
  'reference_video_hd_preview_loading': '高清视频已完成，正在刷新预览…',
  'reference_video_hd_failed': '高清处理失败',
  'reference_cancel_task': '取消任务',
  'reference_cancelling_task': '正在取消',
  'reference_cancel_all_video_tasks': '取消全部视频任务',
  'reference_cancel_single_title': '取消当前视频任务？',
  'reference_cancel_single_description': '将中断当前单元正在进行的提示词优化、视频生成或高清处理任务。',
  'reference_cancel_all_title': '取消本集全部视频任务？',
  'reference_cancel_all_description': '将中断本集正在进行的全部提示词优化、视频生成和高清处理任务，共 {{count}} 个。',
  'reference_cancel_confirm': '确认取消',
  'reference_cancel_loading': '正在取消…',
  'reference_cancel_success': '已提交取消，共影响 {{count}} 个任务',
  'reference_cancel_nothing': '当前没有可取消的视频任务',
  'reference_cancel_failed': '取消视频任务失败：{{error}}',
  'h3_hd_progress_aria': 'MiniMax H3 高清处理进度',
  'h3_hd_progress_submitted': '已提交',
  'h3_hd_progress_queued': '排队中',
  'h3_hd_progress_preparing': '准备中',
  'h3_hd_progress_processing': '高清处理',
  'h3_hd_progress_submitted_detail': '高清任务已提交',
  'h3_hd_progress_queued_waiting': '高清任务正在排队，等待获取位置…',
  'h3_hd_progress_queued_detail': '高清任务正在排队，前面 {{ahead}} 个（队列共 {{total}} 个）',
  'h3_hd_progress_preparing_detail': '正在准备高清处理资源…',
  'h3_hd_progress_running_detail': '正在高清处理 {{progress}}%',
  'h3_hd_progress_cancelling_detail': '正在取消高清任务…',
  'h3_hd_progress_cancel': '取消高清处理',
  ...
  'course_episode_analysis_success': '第 {{episode}} 集解析完成，请复核并标记完成',
