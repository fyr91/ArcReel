...
export default {
  ...
  'route_reference_video_desc': '按 Video Unit 从正式文稿并行生成 Video Unit Storyboard Sheet 与 Keyframes，分别审核后与资产图一起作为视频参考',
  ...
  'reference_storyboard_sheet_title': '分镜版',
  'reference_storyboard_sheet_confirmed_badge': '已确认',
  'reference_storyboard_sheet_pending_badge': '待确认',
  'reference_storyboard_sheet_generating': '正在生成分镜版…',
  'reference_storyboard_sheet_not_generated': '分镜版尚未生成',
  'reference_storyboard_sheet_help': '这是当前整个 Video Unit 的镜头顺序与场景变化预览。它与关键分镜都直接来自正式文稿，可并行生成并分别审核。',
  'reference_storyboard_sheet_generate': '生成分镜版',
  'reference_storyboard_sheet_regenerate': '重新生成分镜版',
  'reference_storyboard_sheet_description': '分镜版图片描述',
  'reference_storyboard_sheet_description_placeholder': '使用与正式文稿一致的 @[角色]、@[场景]、@[道具] 描述分镜版内容',
  ...
  'reference_storyboard_sheet_confirm_and_generate': '确认 Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_confirm': '确认 Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_manuscript_changed_hint': '正式文稿或图片描述在这张分镜版生成后有过变动。当前结果仍可继续使用，也可由你决定是否重新生成。',
  'reference_keyframe_storyboard_gate': '关键分镜与 Storyboard 同级，可直接从正式文稿独立生成。',
