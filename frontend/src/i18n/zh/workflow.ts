...
export default {
  ...
  'step_storyboard': '分镜图',
  'step_video_unit_storyboard_sheet': '视频单元故事板',
  ...
  'task_type_reference_storyboard_sheet': '视频单元故事板',
  ...
  'action_confirm_episode_overview': '复核并确认这一集的解析结果',
  ...
  'action_generate_reference_storyboard_sheets': '生成缺失的视频单元故事板',
  'action_confirm_reference_storyboard_sheet': '审阅并确认当前视频单元故事板',
