...
export default {
  ...
  'content_mode_course_desc': 'One document per episode, combining an opening, story scenes, knowledge explanations, and a closing with a lecturer picture-in-picture.',
  ...
  'config_import_title': 'Import local runtime configuration',
  'config_import_description': 'Drop the administrator-provided .env.release file to load Agent, channel, and Supabase settings in one step. The file is parsed only in memory by your local backend and is never uploaded to the cloud.',
  'config_import_drop': 'Drop the configuration file here',
  'config_import_hint': 'Or click to choose a .env / .env.release file, up to 1 MB',
  'config_import_choose_file': 'Choose a local configuration file',
  'config_import_importing': 'Securely importing configuration…',
  'config_import_later': 'Configure later',
  'config_import_file_type_error': 'Choose a .env or .release configuration file',
  'config_import_incomplete': 'The file was imported, but required configuration is still missing',
  'config_import_missing': 'Missing: {{items}}',
  'config_import_issue_agent': 'Agent',
  'config_import_issue_supabase': 'Supabase character catalog',
  'config_import_issue_provider_image': 'image channel',
  'config_import_issue_provider_video': 'video channel',
  'config_import_issue_provider_text': 'text channel',
  'environment_import_nav': 'Import environment',
  'environment_import_kicker': 'Environment',
  'environment_import_title': 'Import and update environment',
  'environment_import_description': 'Drop a new .env.release file to replace Agent, channel, and system settings and make every project inherit the new environment.',
  'environment_import_checking': 'Validating configuration file…',
  'environment_import_warning': 'This disables old channel credentials not present in the file and clears model, resolution, text, and audio overrides from every project. Project content, assets, styles, and generated results are preserved.',
  'environment_import_confirm_title': 'Replace the current runtime environment?',
  'environment_import_confirm_description': 'The configuration file passed validation. Applying it updates:',
  'environment_import_preview_providers': '{{builtin}} built-in channels and {{custom}} custom channels',
  'environment_import_preview_settings': '{{count}} system settings',
  'environment_import_preview_projects': 'Runtime overrides in {{count}} projects',
  'environment_import_confirm': 'Replace environment',
  'environment_import_success': 'Environment updated; all projects now inherit the new settings',
  ...
  'workflow_start_production': 'Start production',
  'workflow_next_step': 'Next step',
  'workflow_start_production_prompt': 'Start production. Check the latest workflow plan for this project and carry out the next step: {{step}}.',
  'workflow_continue_prompt': 'Check the latest workflow plan for this project and carry out the next step: {{step}}.',
  ...
  'task_type_reference_video_refine': 'HD processing',
  'task_type_tts': 'Voiceover',
  'task_type_voice_sample': 'Voice Sample',
  'task_type_grid': 'Multi-grid storyboard',
  'task_type_hyperframes_bgm': 'HyperFrames background music',
  ...
  'project_path_revealed': 'Revealed “{{path}}” in the file manager',
  'project_path_reveal_failed': 'Could not reveal the project file: {{message}}',
  'project_path_no_active_project': 'There is no active project to reveal',
  ...
  'course_video_mode': 'Course Video',
  ...
  'episode_narrator_label': 'Narrator',
  'episode_narrator_inherit_value': 'Inherit project · {{name}}',
  'episode_narrator_inherit_empty': 'Inherit project · model decides',
  'episode_narrator_saved': 'Episode narrator updated',
  ...
  'default_narrator_title': 'Default narrator',
  'default_narrator_label': 'Narrator character',
  'default_narrator_none': 'Not specified · model decides',
  'default_narrator_hint': 'Bare {voiceover} lines use this character’s reference audio in H3. Episodes can override it independently.',
  ...
  'route_reference_video_desc': 'Generate the Video Unit Storyboard Sheet and Keyframes in parallel from the formal manuscript, review them separately, then use both with asset images as video references',
  ...
  'reference_storyboard_sheet_generating': 'Generating Storyboard…',
  'reference_storyboard_sheet_not_generated': 'Storyboard has not been generated',
  'reference_storyboard_sheet_help': 'This sheet previews the shot order and scene changes for the entire Video Unit. It and the Keyframes derive independently from the formal manuscript and can be generated in parallel.',
  'reference_storyboard_sheet_generate': 'Generate Storyboard',
  'reference_storyboard_sheet_regenerate': 'Regenerate Storyboard',
  'reference_storyboard_sheet_description': 'Storyboard image description',
  'reference_storyboard_sheet_prompt_mode': 'Switch Storyboard image prompt mode',
  'reference_storyboard_sheet_full_prompt': 'Full Storyboard prompt',
  'reference_storyboard_sheet_description_placeholder': 'Describe the Storyboard with the same @[character], @[scene], and @[prop] references used by the formal manuscript',
  'reference_storyboard_sheet_instructions_label': 'Generation review notes',
  'reference_storyboard_sheet_instructions_placeholder': 'Optional: panel-level review notes for this generation or regeneration. These do not rewrite the script.',
  'reference_storyboard_sheet_confirm_and_generate': 'Confirm Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_confirm': 'Confirm Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_manuscript_changed_hint': 'The formal manuscript or image description changed after this Storyboard was generated. You can keep using it or regenerate it.',
  'reference_keyframe_storyboard_gate': 'Keyframes and the Storyboard are siblings and can be generated independently from the formal manuscript.',
  ...
  'reference_keyframe_prompt_mode': 'Switch Keyframe image prompt mode',
  'reference_keyframe_full_prompt': 'Full Keyframe prompt',
  'reference_image_prompt_mode_description': 'Image description',
  'reference_image_prompt_mode_full': 'Full prompt',
  'reference_image_full_prompt_placeholder': 'View and edit the full prompt sent to the image model for this image',
  ...
  'script_preview_define_voice': 'Set voice',
  ...
  'course_episode_analysis_tab': 'Episode analysis',
  'course_episode_analysis_draft': 'Needs review',
  'course_episode_analysis_confirmed': 'Completed',
  'course_episode_save_and_confirm': 'Save and mark complete',
  'course_episode_overview_confirmed': 'Episode analysis saved and marked complete',
  'course_episode_overview_confirm_failed': 'Failed to save episode analysis: {{message}}',
  ...
  'hyperframes_editing_state_assembly_draft': 'Sequential assembly draft · no AI picture edit yet',
  'hyperframes_editing_state_edited': 'AI picture edit applied ({{count}} signals)',
  'hyperframes_retry': 'Retry',
  'hyperframes_open_new_window': 'Open in new window',
  'hyperframes_bgm_task_progress': 'Background music generation progress',
  'hyperframes_bgm_status_queued': 'Background music queued (position {{position}})',
  'hyperframes_bgm_status_running': 'Generating background music {{progress}}%',
  'hyperframes_bgm_status_cancelling': 'Cancelling background music…',
  'hyperframes_bgm_status_succeeded': 'Background music generated and added to the timeline',
  'hyperframes_bgm_status_failed': 'Background music generation failed',
  'hyperframes_bgm_status_cancelled': 'Background music task cancelled',
  ...
  'tool_name_get_project_path_link': 'Create project file location link',
  ...
  'tool_name_normalize_reference_keyframe_mentions': 'Normalize keyframe asset mentions',
  'tool_name_replace_reference_script_text': 'Batch exact manuscript corrections',
  ...
  'tool_name_confirm_reference_video': 'Confirm current video',
  ...
  'tool_name_inspect_hyperframes_episode': 'Inspect HyperFrames edit state',
  'tool_name_generate_hyperframes_bgm': 'Generate HyperFrames background music',
  'tool_name_make_reference_video_hd': 'Make video HD',
  'tool_name_cancel_reference_video_tasks': 'Cancel video tasks',
  ...
  'tool_name_patch_episode_meta': 'Edit episode metadata',
  'tool_name_confirm_episode_overview': 'Confirm episode analysis',
  ...
  'lobby_hero_subtitle_cheerup': 'Bring great stories to life.',
  ...
  'course_unit_type': 'Unit type',
  'course_unit_opening': 'Opening',
  'course_unit_story': 'Story',
  'course_unit_explanation': 'Knowledge explanation',
  'course_unit_closing': 'Closing summary',
  'course_unit_related_assets': 'Assets referenced by the script',
  'course_unit_assets_empty': 'None referenced',
  'course_unit_scenes': 'Scenes',
  'course_unit_characters': 'Characters',
  'course_unit_presenters': 'Lecturers',
  'course_unit_props': 'Props',
  'course_role': 'Course role',
  'course_role_actor': 'Actor',
  'course_role_main_lecturer': 'Main lecturer',
  'course_role_guest_lecturer': 'Guest lecturer',
  'course_video_confirm': 'Confirm this video',
  'course_video_confirmed': 'Video confirmed',
  'reference_video_hd': 'HD',
  'reference_video_hd_processing': 'Making HD',
  'reference_video_hd_completed': 'HD ready',
  'reference_video_hd_retry': 'Retry',
  'reference_video_hd_preview_label': 'HD video',
  'reference_video_hd_preview_empty': 'HD progress and the finished video will appear here',
  'reference_video_hd_preview_loading': 'HD processing is complete; refreshing the preview…',
  'reference_video_hd_failed': 'HD processing failed',
  'reference_cancel_task': 'Cancel task',
  'reference_cancelling_task': 'Cancelling',
  'reference_cancel_all_video_tasks': 'Cancel all video tasks',
  'reference_cancel_single_title': 'Cancel this video task?',
  'reference_cancel_single_description': 'This interrupts prompt optimization, video generation, or HD processing for the current unit.',
  'reference_cancel_all_title': 'Cancel all video tasks in this episode?',
  'reference_cancel_all_description': 'This interrupts all prompt optimization, video generation, and HD processing tasks in this episode ({{count}} tasks).',
  'reference_cancel_confirm': 'Cancel tasks',
  'reference_cancel_loading': 'Cancelling…',
  'reference_cancel_success': 'Cancellation submitted for {{count}} tasks',
  'reference_cancel_nothing': 'There are no video tasks to cancel',
  'reference_cancel_failed': 'Failed to cancel video tasks: {{error}}',
  'h3_hd_progress_aria': 'MiniMax H3 HD processing progress',
  'h3_hd_progress_submitted': 'Submitted',
  'h3_hd_progress_queued': 'Queued',
  'h3_hd_progress_preparing': 'Preparing',
  'h3_hd_progress_processing': 'Make HD',
  'h3_hd_progress_submitted_detail': 'HD task submitted',
  'h3_hd_progress_queued_waiting': 'HD task queued; waiting for position…',
  'h3_hd_progress_queued_detail': 'HD task queued with {{ahead}} ahead ({{total}} total)',
  'h3_hd_progress_preparing_detail': 'Preparing HD processing assets…',
  'h3_hd_progress_running_detail': 'Making HD {{progress}}%',
  'h3_hd_progress_cancelling_detail': 'Cancelling the HD task…',
  'h3_hd_progress_cancel': 'Cancel HD processing',
  ...
  'course_episode_analysis_success': 'Episode {{episode}} analysis is ready for review',
