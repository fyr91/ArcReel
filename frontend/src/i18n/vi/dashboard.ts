...
export default {
  ...
  'environment_import_nav': 'Nhập môi trường',
  'environment_import_kicker': 'Environment',
  'environment_import_title': 'Nhập và cập nhật môi trường',
  'environment_import_description': 'Thả tệp .env.release mới để thay thế cấu hình Agent, kênh và hệ thống, đồng thời cho mọi dự án kế thừa môi trường mới.',
  'environment_import_checking': 'Đang xác thực tệp cấu hình…',
  'environment_import_warning': 'Thao tác này vô hiệu hóa thông tin kênh cũ không có trong tệp và xóa ghi đè mô hình, độ phân giải, văn bản và âm thanh của mọi dự án. Nội dung, tài sản, phong cách và kết quả đã tạo được giữ nguyên.',
  'environment_import_confirm_title': 'Thay thế môi trường chạy hiện tại?',
  'environment_import_confirm_description': 'Tệp cấu hình đã hợp lệ. Khi áp dụng sẽ cập nhật:',
  'environment_import_preview_providers': '{{builtin}} kênh tích hợp và {{custom}} kênh tùy chỉnh',
  'environment_import_preview_settings': '{{count}} cài đặt hệ thống',
  'environment_import_preview_projects': 'Ghi đè thời gian chạy của {{count}} dự án',
  'environment_import_confirm': 'Thay thế môi trường',
  'environment_import_success': 'Môi trường đã được cập nhật; mọi dự án hiện kế thừa cài đặt mới',
  ...
  'task_type_reference_video_refine': 'Xử lý HD',
  ...
  'project_path_revealed': 'Đã định vị “{{path}}” trong trình quản lý tệp',
  'project_path_reveal_failed': 'Không thể định vị tệp dự án: {{message}}',
  'project_path_no_active_project': 'Không có dự án đang hoạt động để định vị',
  ...
  'episode_narrator_label': 'Người dẫn tập này',
  'episode_narrator_inherit_value': 'Kế thừa dự án · {{name}}',
  'episode_narrator_inherit_empty': 'Kế thừa dự án · mô hình quyết định',
  'episode_narrator_saved': 'Đã cập nhật người dẫn của tập',
  ...
  'default_narrator_title': 'Người dẫn mặc định',
  'default_narrator_label': 'Nhân vật dẫn chuyện',
  'default_narrator_none': 'Không chỉ định · mô hình quyết định',
  'default_narrator_hint': 'Các dòng {lời dẫn} không ghi tên sẽ dùng âm thanh tham chiếu của nhân vật này trong H3; từng tập có thể ghi đè.',
  ...
  'reference_storyboard_sheet_prompt_mode': 'Chuyển chế độ lời nhắc ảnh bảng phân cảnh',
  'reference_storyboard_sheet_full_prompt': 'Lời nhắc đầy đủ của bảng phân cảnh',
  ...
  'reference_keyframe_prompt_mode': 'Chuyển chế độ lời nhắc ảnh khung hình chính',
  'reference_keyframe_full_prompt': 'Lời nhắc đầy đủ của khung hình chính',
  'reference_image_prompt_mode_description': 'Mô tả hình ảnh',
  'reference_image_prompt_mode_full': 'Lời nhắc đầy đủ',
  'reference_image_full_prompt_placeholder': 'Xem và chỉnh sửa lời nhắc đầy đủ được gửi tới mô hình ảnh cho hình này',
  ...
  'script_preview_define_voice': 'Đặt giọng nói',
  ...
  'course_episode_analysis_tab': 'Phân tích tập',
  'course_episode_analysis_draft': 'Cần xác nhận',
  'course_episode_analysis_confirmed': 'Đã hoàn tất',
  'course_episode_save_and_confirm': 'Lưu và đánh dấu hoàn tất',
  'course_episode_overview_confirmed': 'Đã lưu và đánh dấu hoàn tất phân tích tập',
  'course_episode_overview_confirm_failed': 'Không thể lưu phân tích tập: {{message}}',
  ...
  'lobby_hero_subtitle_cheerup': 'Cho những câu chuyện hay chuyển động.',
  ...
  'tool_name_get_project_path_link': 'Tạo liên kết vị trí tệp dự án',
  ...
  'tool_name_confirm_reference_video': 'Xác nhận video hiện tại',
  ...
  'tool_name_make_reference_video_hd': 'Làm video HD',
  'tool_name_cancel_reference_video_tasks': 'Hủy tác vụ video',
  ...
  'tool_name_confirm_episode_overview': 'Xác nhận phân tích tập',
  ...
  'course_unit_related_assets': 'Tài nguyên được nhắc trong kịch bản',
  'course_unit_assets_empty': 'Không có tham chiếu',
  'course_unit_scenes': 'Bối cảnh',
  'course_unit_characters': 'Nhân vật',
  ...
  'reference_video_hd': 'HD',
  'reference_video_hd_processing': 'Đang làm HD',
  'reference_video_hd_completed': 'Đã HD',
  'reference_video_hd_retry': 'Thử lại',
  'reference_video_hd_preview_label': 'Video HD',
  'reference_video_hd_preview_empty': 'Tiến trình HD và video hoàn tất sẽ xuất hiện tại đây',
  'reference_video_hd_preview_loading': 'Xử lý HD đã hoàn tất; đang làm mới bản xem trước…',
  'reference_video_hd_failed': 'Xử lý HD thất bại',
  'reference_cancel_task': 'Hủy tác vụ',
  'reference_cancelling_task': 'Đang hủy',
  'reference_cancel_all_video_tasks': 'Hủy tất cả tác vụ video',
  'reference_cancel_single_title': 'Hủy tác vụ video này?',
  'reference_cancel_single_description': 'Thao tác này sẽ dừng tối ưu lời nhắc, tạo video hoặc xử lý HD của đơn vị hiện tại.',
  'reference_cancel_all_title': 'Hủy tất cả tác vụ video trong tập này?',
  'reference_cancel_all_description': 'Thao tác này sẽ dừng toàn bộ tác vụ tối ưu lời nhắc, tạo video và xử lý HD trong tập này ({{count}} tác vụ).',
  'reference_cancel_confirm': 'Xác nhận hủy',
  'reference_cancel_loading': 'Đang hủy…',
  'reference_cancel_success': 'Đã gửi yêu cầu hủy cho {{count}} tác vụ',
  'reference_cancel_nothing': 'Không có tác vụ video nào để hủy',
  'reference_cancel_failed': 'Không thể hủy tác vụ video: {{error}}',
  'h3_hd_progress_aria': 'Tiến trình xử lý HD MiniMax H3',
  'h3_hd_progress_submitted': 'Đã gửi',
  'h3_hd_progress_queued': 'Đang xếp hàng',
  'h3_hd_progress_preparing': 'Đang chuẩn bị',
  'h3_hd_progress_processing': 'Xử lý HD',
  'h3_hd_progress_submitted_detail': 'Đã gửi tác vụ HD',
  'h3_hd_progress_queued_waiting': 'Tác vụ HD đang xếp hàng; chờ vị trí…',
  'h3_hd_progress_queued_detail': 'Tác vụ HD còn {{ahead}} tác vụ phía trước (tổng {{total}})',
  'h3_hd_progress_preparing_detail': 'Đang chuẩn bị tài nguyên xử lý HD…',
  'h3_hd_progress_running_detail': 'Đang xử lý HD {{progress}}%',
  'h3_hd_progress_cancelling_detail': 'Đang hủy tác vụ HD…',
  'h3_hd_progress_cancel': 'Hủy xử lý HD',
  ...
  'course_episode_analysis_success': 'Phân tích tập {{episode}} đã sẵn sàng để xem lại',
