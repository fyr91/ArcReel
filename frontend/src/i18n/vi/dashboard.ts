...
export default {
  ...
  'route_reference_video_desc': 'Tạo song song Video Unit Storyboard Sheet và Keyframes từ bản thảo chính thức, duyệt riêng rồi dùng cả hai cùng ảnh tài sản làm tham chiếu video',
  ...
  'reference_storyboard_sheet_title': 'Storyboard',
  'reference_storyboard_sheet_confirmed_badge': 'Đã xác nhận',
  'reference_storyboard_sheet_pending_badge': 'Chờ xác nhận',
  'reference_storyboard_sheet_generating': 'Đang tạo Storyboard…',
  'reference_storyboard_sheet_not_generated': 'Storyboard chưa được tạo',
  'reference_storyboard_sheet_help': 'Sheet này mô tả thứ tự cảnh quay và thay đổi bối cảnh của toàn bộ Video Unit. Sheet và Keyframes cùng được tạo độc lập từ bản thảo chính thức và có thể chạy song song.',
  'reference_storyboard_sheet_generate': 'Tạo Storyboard',
  'reference_storyboard_sheet_regenerate': 'Tạo lại Storyboard',
  'reference_storyboard_sheet_description': 'Mô tả ảnh Storyboard',
  'reference_storyboard_sheet_description_placeholder': 'Mô tả Storyboard bằng cùng cú pháp @[nhân vật], @[bối cảnh], @[đạo cụ] như bản thảo chính thức',
  ...
  'reference_storyboard_sheet_confirm_and_generate': 'Xác nhận Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_confirm': 'Xác nhận Video Unit Storyboard Sheet',
  'reference_storyboard_sheet_manuscript_changed_hint': 'Bản thảo chính thức hoặc mô tả ảnh đã thay đổi sau khi Storyboard này được tạo. Bạn vẫn có thể dùng kết quả hiện tại hoặc tạo lại.',
  'reference_keyframe_storyboard_gate': 'Keyframes và Storyboard là hai đầu ra ngang hàng, có thể tạo độc lập từ bản thảo chính thức.',
  'reference_keyframe_manuscript_changed_hint': 'Bản thảo chính thức hoặc mô tả ảnh đã thay đổi sau khi Keyframe này được tạo. Bạn vẫn có thể dùng kết quả hiện tại hoặc tạo lại.',
