...
export default {
  ...
  'step_video_unit_storyboard_sheet': 'Bảng phân cảnh đơn vị video',
  ...
  'task_type_reference_storyboard_sheet': 'Bảng phân cảnh đơn vị video',
  ...
  'action_generate_reference_storyboard_sheets': 'tạo các bảng phân cảnh đơn vị video còn thiếu',
  'action_confirm_reference_storyboard_sheet': 'xem xét và xác nhận bảng phân cảnh đơn vị video hiện tại',
