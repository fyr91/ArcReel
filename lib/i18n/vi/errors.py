MESSAGES = {
    ...
    "company_asset_invalid_type": "Loại tài sản công ty không hợp lệ",
    "company_asset_invalid_payload": "Danh mục tài sản công ty trả về dữ liệu không hợp lệ",
    "company_asset_request_failed": "Không thể truy cập danh mục tài sản công ty; hãy thử lại sau",
    ...
    "company_asset_file_too_large": "Tệp tài sản vượt quá 200 MB nên không thể xuất bản",
    "company_asset_file_changed": "Tệp tài sản đã thay đổi trong khi xuất bản; hãy thử lại",
    "company_asset_file_size_mismatch": "Tệp tài sản công ty không vượt qua kiểm tra kích thước",
    "company_asset_file_hash_mismatch": "Tệp tài sản công ty không vượt qua kiểm tra tính toàn vẹn",
    "company_asset_sync_failed": "Đồng bộ tài sản công ty thất bại; hãy thử lại hoặc kiểm tra nhật ký máy chủ",
