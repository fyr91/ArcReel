MESSAGES = {
    ...
    "company_asset_invalid_type": "公司资产类型无效",
    "company_asset_invalid_payload": "公司资产库返回了无效的数据",
    "company_asset_request_failed": "无法访问公司资产库，请稍后重试",
    ...
    "company_asset_file_too_large": "资产文件超过 200 MB，无法发布",
    "company_asset_file_changed": "资产文件在发布期间发生变化，请重试",
    "company_asset_file_size_mismatch": "公司资产文件大小校验失败",
    "company_asset_file_hash_mismatch": "公司资产文件完整性校验失败",
    "company_asset_sync_failed": "公司资产同步失败，请重试或检查服务日志",
