MESSAGES = {
    ...
    "asset_audio_upload_too_large": "语音文件大小超过限制（20MB）",
    "asset_audio_unsupported_format": "语音仅支持 wav/mp3/m4a/aac/ogg/flac",
    "asset_audio_character_only": "只有人物资产可以添加语音组",
    "asset_resource_limit": "单个资产最多可保存 {limit} 个图片和语音文件",
    "asset_resource_selection_invalid": "资源组选择无效，请刷新后重试",
    "asset_catalog_resource_read_only": "同步来源的资源由数据源管理，不能在本地资源组中删除",
