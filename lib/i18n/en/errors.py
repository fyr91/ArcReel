MESSAGES = {
    ...
    "company_asset_invalid_type": "Invalid company asset type",
    "company_asset_invalid_payload": "The company catalog returned invalid data",
    "company_asset_request_failed": "Could not reach the company asset catalog; try again later",
    ...
    "company_asset_file_too_large": "An asset file exceeds 200 MB and cannot be published",
    "company_asset_file_changed": "An asset file changed during publication; try again",
    "company_asset_file_size_mismatch": "A company asset file failed its size check",
    "company_asset_file_hash_mismatch": "A company asset file failed its integrity check",
    "company_asset_sync_failed": "Company asset sync failed; try again or check the server logs",
