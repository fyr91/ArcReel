MESSAGES = {
    ...
    "narrator_reference_video_only": "A default narrator character is only available for drama or course reference-video projects",
    "narrator_character_invalid": "The narrator character must be a character name or null",
    "narrator_character_not_found": "Narrator character '{name}' is not registered in the character collection",
    ...
    "course_episode_delete_not_course": "Only course projects support deleting an individual episode",
    "course_episode_delete_not_found": "Course episode {episode} does not exist",
    "course_episode_delete_invalid_project": "Course episode {episode} has invalid data and cannot be deleted safely",
    "course_episode_delete_protected_resource": "Course episode {episode} unexpectedly references a library file; deletion was refused to protect the resource library",
    "course_episode_delete_shared_file": "Course episode {episode} shares a file with another episode and cannot be deleted independently",
    "course_episode_delete_confirmation_required": "Review the deletion scope and confirm before deleting the episode",
    "course_episode_delete_confirmation_expired": "The deletion confirmation expired; review the scope and confirm again",
    "course_episode_delete_confirmation_invalid": "The deletion confirmation is invalid or belongs to another episode; confirm again",
    "course_episode_delete_confirmation_stale": "The episode changed after confirmation and was not deleted; review the scope and confirm again",
    ...
    "reference_keyframe_plan_required": "Video unit '{unit_id}' has no keyframes derived from its formal manuscript; regenerate the Video Unit manuscript",
    "reference_keyframes_required": "Video unit '{unit_id}' has no Keyframes derived from its formal manuscript; regenerate the Video Unit manuscript",
    ...
    "video_guided_continuation_unsupported": "{provider}/{model} does not support guided video continuation; switch this video lane to Croco MiniMax H3",
    "video_guided_continuation_mode_unsupported": "Model {model} cannot combine Guided continuation with hard first-frame mode; use reference-to-video for the current storyboard",
    "video_guided_continuation_end_frame_unsupported": "Model {model} cannot combine Guided continuation with a fixed end frame; remove the end frame before generating this continuation",
    "video_guided_source_unavailable": "GPU source job {source_job_id} cannot be used for Guided continuation ({reason}); regenerate the source unit with Croco MiniMax H3",
    ...
    "video_hd_backend_unavailable": "The MiniMax H3 HD backend is temporarily unavailable; try again later",
    "video_hd_failed": "HD processing failed for {unit_ids}; the original 480P videos were preserved. Try again",
    ...
    "project_path_invalid": "Only relative paths inside the current project can be revealed",
    "project_path_not_found": "The project file or folder to reveal does not exist",
    "local_file_manager_unavailable": "Could not open the local file manager; make sure the service is running directly in a local desktop environment",
    ...
    "config_import_disabled": "Configuration file import is not enabled for this instance",
    "config_bundle_read_failed": "Could not read the configuration file",
    ...
    "config_bundle_file_credential_unsupported": "This instance has a file-based channel credential that cannot be exported to .env.release yet",
    "config_bundle_provider_unknown": "The configuration contains a channel unsupported by this version",
