...
Release Branch 新建项目默认使用 MiniMax H3（480p）生成视频、Seedream 5.0 Lite 生成图片、Nano Banana 2 Lite 生成 Storyboard；默认文本模型和复杂任务使用 DeepSeek V4 Pro，简单任务使用 MiniMax M3。所有值都会写入项目配置，之后仍可在项目设置中修改。
