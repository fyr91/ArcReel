...
**脚本（script）**：
ArcReel 根据剧本文档、课程文档或广告指令整理出的结构化创作内容，用于后续生成分镜或视频单元。
...
**课程文档（course document）**：
用户为课程视频单个 Episode 上传的文档；一份文档只形成一集，不自动拆分成多集。
_Avoid_: 将它称为小说或分集规划输入。
...
**对应原文（source_text）**：
一个分镜或视频单元所依据的剧本或课程文档文本，用于创作者对照来源，不会作为独立内容被朗读或生成。
_Avoid_: 把对应原文当作旁白文本。
